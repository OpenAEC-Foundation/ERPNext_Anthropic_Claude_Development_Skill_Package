...
This skill helps you implement scheduled tasks and background jobs. For exact syntax, see `frappe-syntax-scheduler`.
...
- `frappe-syntax-scheduler` - Exact syntax reference
